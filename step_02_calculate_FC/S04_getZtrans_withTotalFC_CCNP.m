%% 
clear;
proj_dir = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/CCNP/code/3rd_calFC';
datapath = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/CCNP/results';
load subid_final_CCNP_under6.mat;
subList = subid_final_CCNP;
...
writelines(subList, fullfile(savepath,'subjects_order.txt'));
