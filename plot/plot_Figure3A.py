...
# datapath
# =============================
pvalue_folder = "/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/post_prediction/get_significance/Cognition"
file_folder   = "/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/ABCD/code/5th_prediction/PLS_prediction/networkFC/cognition_nosmooth_motion2runFD"
...
figure_folder = "/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/Figure/Cog_raincloud"
os.makedirs(figure_folder, exist_ok=True)
filename1 = "cog_raincloud_addsig.tiff"
filename2 = "cog_raincloud_addsig.pdf"
...
def smart_loadmat(path):
    ...
    try:
        ...
        print(f"[smart_loadmat] {path} using mat73.loadmat read (v7.3)")
...
dataset_key_to_label = {
    "nihtbx_totalcomp": "Total",
    "nihtbx_cryst":     "Crystal",
    "nihtbx_fluidcomp": "Fluid",
}

dataset_order = ["Total", "Crystal", "Fluid"]
...
name_list = dataset_order[:]  # x-axis labels (Total / Crystal / Fluid)
...
plt.yticks(np.arange(y_min, y_top_data + 1e-9, ytick_interval), fontsize=12)
