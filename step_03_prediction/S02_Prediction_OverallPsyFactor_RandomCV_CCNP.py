...
import os
import sys
sys.path.append('/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/CCNP/code/4th_prediction/nosmooth_n193_delete_under6');
import PLSr1_CZ_Random_RegressCovariates

targetStr = 'age'
outFolder = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/CCNP/code/4th_prediction/nosmooth_n193_delete_under6/age_withHaufe_Schaefer100/CCNP_'+ targetStr

# Import data
# 1. atlas loading
GG_datapath = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/CCNP/results/totalFC/total_FCvector_GG.txt';
GW_datapath = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/CCNP/results/totalFC/total_FCvector_GW.txt';
WW_datapath = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/CCNP/results/totalFC/total_FCvector_WW.txt';
...
labelpath = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/CCNP/code/4th_prediction/demo/demo_age_sex_193_delete_under6.csv';
...
# 3. covariates  
covariatespath = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/CCNP/code/4th_prediction/demo/demo_age_sex_193_delete_under6.csv';
