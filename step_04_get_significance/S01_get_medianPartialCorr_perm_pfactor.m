...
targetStr_total = {'ADHD'; 'Ext'; 'General'; 'Int'};

targetDir = [ProjectFolder '/ABCD/code/5th_prediction/PLS_prediction/networkFC/p_factor_nosmooth_motion2runFD'];
...
for i_str = 1:num_targets
    ...
    BaseFolder = [targetDir, '/', targetStr , '/RegressCovariates_RandomCV_Permutation'];
...
saveFolder = [ProjectFolder '/post_prediction/get_significance/pfactor'];
