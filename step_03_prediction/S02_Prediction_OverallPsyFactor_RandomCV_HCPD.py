...
import os
import sys
sys.path.append('/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/HCPD/code/4th_prediction/s02_PLSprediction/nosmooth');
import PLSr1_CZ_Random_RegressCovariates

targetStr = 'interview_age'
outFolder = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/HCPD/code/4th_prediction/s02_PLSprediction/nosmooth/age_withHaufe_Schaefer100/HCPD_'+ targetStr

# Import data
# 1. atlas loading
GG_datapath = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/HCPD/results/FC_total_nosmooth/total_FCvector_GG.txt';
GW_datapath = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/HCPD/results/FC_total_nosmooth/total_FCvector_GW.txt';
WW_datapath = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/HCPD/results/FC_total_nosmooth/total_FCvector_WW.txt';
...
labelpath =  '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/HCPD/code/4th_prediction/s01_preparedata/HCPD_demoCombined_531.csv';
...
# 3. covariates  
covariatespath = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/HCPD/code/4th_prediction/s01_preparedata/HCPD_covariates_531.csv';
