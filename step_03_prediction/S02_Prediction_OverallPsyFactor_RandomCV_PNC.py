...
import os
import sys
sys.path.append('/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/PNC/code/4th_prediction/nosmooth');
import PLSr1_CZ_Random_RegressCovariates

targetStr = 'age'
outFolder = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/PNC/code/4th_prediction/nosmooth/age_withHaufe_Schaefer100/PNC_'+ targetStr

# Import data
# 1. atlas loading
GG_datapath = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/PNC/results/FCmatrix_total_nosmooth/total_FCvector_GG.txt';
GW_datapath = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/PNC/results/FCmatrix_total_nosmooth/total_FCvector_GW.txt';
WW_datapath = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/PNC/results/FCmatrix_total_nosmooth/total_FCvector_WW.txt';
...
labelpath = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/PNC/code/4th_prediction/demo/demography_age_sex_PNC.csv';
...
# 3. covariates  
covariatespath = '/ibmgpfs/cuizaixu_lab/congjing/WM_prediction/PNC/code/4th_prediction/demo/demography_age_sex_PNC.csv';
